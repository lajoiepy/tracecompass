...
//    public Predicate<ITimeEvent> generate(Function<ITimeEvent, Map<String, String>> tooltipProvider) {
...
//    }
    public BiPredicate<ITimeEvent, Function<ITimeEvent, Map<String, String>>> generate() {
