...
//    public TimeEventFilterSimpleExpression generate(Function<ITimeEvent, Map<String, String>> tooltipProvider) {
    ...
    public enum ConditionOperator implements BiPredicate<String, String> {
        ...
        private static boolean greaterThanComparison(String i, String j) {
            try {
                ...
                Activator.getDefault().logWarning("The search criteria is not a number"); //$NON-NLS-1$
                return false;
            }
        }
