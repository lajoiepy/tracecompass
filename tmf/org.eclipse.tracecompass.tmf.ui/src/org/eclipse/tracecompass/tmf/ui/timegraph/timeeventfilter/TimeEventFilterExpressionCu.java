...
public class TimeEventFilterExpressionCu {
    ...
    public static TimeEventFilterExpressionCu compile(CommonTree treeNode) {
        ...
        if (leftTree == null) {
            Activator.getDefault().logError("At least one expression is needed", new IllegalArgumentException("Invalid time event filter"));
        }
...
//    public TimeEventFilterExpression generate(Function<ITimeEvent, Map<String, String>> tooltipProvider) {
